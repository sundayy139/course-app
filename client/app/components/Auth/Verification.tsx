      ...
      <div className="m-auto flex items-center justify-around">
        {Object.keys(verifyNumber).map((key, index) => (
          <input
            ...
            key={key}
            ref={inputRefs[index]}
            className={`w-[65px] h-[65px] border-[3px] rounded-[10px] flex items-center text-black dark:text-white justify-center text-lg font-Poppins outline-none text-center ${
              invalidError
